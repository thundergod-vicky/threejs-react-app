...
// Import assets
import island2 from '../../assets/island2.mp4';
...
const Island2 = ({ onNavigate, onBack }) => {
    ...
    const islandData = {
        ...
        description: "The historic lighthouse of Isokari has guided ships through the treacherous waters of the Gulf of Bothnia for over a century. Brave lighthouse keepers lived in isolation, maintaining the beacon that saved countless lives from the rocky shores.",
        date: "15/07/2025",
        time: "14:23",
        coordinates: "60.7201°N, 21.0165°E"
    };
            ...
            <UIOverlay>
                ...
                <MapContainer footerVisible={showFooter}>
                    <MapSVG viewBox="0 0 280 160">
                        ...
                        {/* Location Marker - Different position for Island 2 */}
                        <circle cx="95" cy="80" r="4" fill="#FF6B35" stroke="white" strokeWidth="2" />
                        <circle cx="95" cy="80" r="8" fill="rgba(255, 107, 53, 0.3)" />

                        {/* Marker dot animation */}
                        <circle cx="95" cy="80" r="2" fill="#FF6B35">

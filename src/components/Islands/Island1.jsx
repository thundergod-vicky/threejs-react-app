...
const Island1 = ({ onNavigate, onBack }) => {
            ...
            <UIOverlay>
                ...
                <MapContainer footerVisible={showFooter}>
                    <MapSVG viewBox="0 0 280 160">
                        ...
                        {/* Location Marker */}
                        <circle cx="85" cy="95" r="4" fill="#FF6B35" stroke="white" strokeWidth="2" />
                        <circle cx="85" cy="95" r="8" fill="rgba(255, 107, 53, 0.3)" />

                        {/* Marker dot animation */}
                        <circle cx="85" cy="95" r="2" fill="#FF6B35">
                ...
                <InfoPanel show={showFooter}>
                    <InfoContent>
                        <InfoTextSection>
                            <InfoTitle>{currentData.title}</InfoTitle>
                            <InfoDescription>{currentData.description}</InfoDescription>
                        </InfoTextSection>
                        <InfoDetails>
                            <DetailItem>
                                <DetailLabel>DATE</DetailLabel>
                                <DetailValue>{currentData.date}</DetailValue>
                            </DetailItem>
                            <DetailItem>
                                <DetailLabel>TIME</DetailLabel>
                                <DetailValue>{currentData.time}</DetailValue>
                            </DetailItem>
                            <DetailItem>
                                <DetailLabel>LOCATION</DetailLabel>
                                <DetailValue>{currentData.coordinates}</DetailValue>
                            </DetailItem>
                        </InfoDetails>
